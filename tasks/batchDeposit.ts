...
task("batchDeposit", "Allows the batch deposit of ERC1155 to multiple ERC721 tokens")
  .addParam("gotchiIds", "String array of Gotchi IDs")
  .addParam("quantity", "The amount of ERC1155 tokens to deposit into each ERC721 token")
  ...
  .setAction(async (taskArgs: TaskArgs, hre: HardhatRuntimeEnvironment) => {
    ...
    const tx: ContractTransaction = await itemsTransfer.batchBatchTransferToParent(
      itemManager,
      diamondAddress,
      uniqueIds,

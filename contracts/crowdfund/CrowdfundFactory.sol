...
contract CrowdfundFactory {
    ...
    event CrowdfundDeployed(address crowdfundProxy, string name, string symbol, address operator);
    ...
    function createCrowdfund(
        ...
        crowdfundProxy = address(new CrowdfundProxy{ salt: keccak256(abi.encode(name_, symbol_, operator_)) }());

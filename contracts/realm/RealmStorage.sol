...
contract RealmStorage {
    ...
    // The factor by which ETH contributions will multiply into Realm tokens.
    ...
    address payable public realmRecipient;
    // We add a hard cap to prevent raising more funds than deemed reasonable.
    // if set to 0, there is no hard cap
    uint256 public realmCap;

...
contract Erc20ConditionalErc721 is ERC165, ERC721 {
    // Points toward the ERC20 contract to coniditionally mint from
    address public conditionERC20;

    // Minimum required balance of conditionERC20 for minting
    uint256 public conditionBalance;
    ...
    constructor(
        address _conditionERC20,
        uint256 _conditionBalance,
        string memory _name,
        string memory _symbol
    ) ERC721(_name, _symbol) {
        conditionERC20 = _conditionERC20;
        conditionBalance = _conditionBalance;
    }
    ...
    function mintNFT(uint256 _tokenId) public {
        require(
            ERC20(conditionERC20).balanceOf(msg.sender) > conditionBalance,
            "Msg.sender does not have minimum required ERC20 to mint"
        );
        require(hasMinted[_tokenId] == false, "NFT already minted for this address!");

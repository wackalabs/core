  ...
  const facets = [
    [
      ...
      await ethers.getContractAt(
        "contracts/Ethereum/facets/AavegotchiFacet.sol:AavegotchiFacet",
        "0xb7fd49c7b662B5135D1bB03b51FfC51a6b908230",
      ),
    ],
    [
      "contracts/Ethereum/facets/BridgeFacet.sol:BridgeFacet",
      await ethers.getContractAt(
        "contracts/Ethereum/facets/BridgeFacet.sol:BridgeFacet",
        "0xb81c32635524c24B02d8286B6Fc5157151e4c273",
      ),
    ],
  ];

  const initDiamond = await ethers.getContractAt(
    "contracts/Ethereum/InitDiamond.sol:InitDiamond",
    "0x8eD0e2DdD3e298E1497578C21f719428A3d93134",
  );
